...
var _generic_button_textures: JoypadButtonTextures = _get_joypad_textures("generic", "buttons")

var _steam_deck_button_textures: JoypadButtonTextures = _get_joypad_textures("steam_deck", "buttons")
...
var _generic_motion_textures: JoypadMotionTextures = _get_joypad_textures("generic", "motion")

var _steam_deck_motion_textures: JoypadMotionTextures = _get_joypad_textures("steam_deck", "motion")
...
func _reload_textures() -> void:
	...
	_generic_button_textures = _get_joypad_textures("generic", "buttons")

	_steam_deck_button_textures = _get_joypad_textures("steam_deck", "buttons")
	...
	_generic_motion_textures = _get_joypad_textures("generic", "motion")

	_steam_deck_motion_textures = _get_joypad_textures("steam_deck", "motion")
...
func get_joypad_button_textures(icons: int) -> JoypadButtonTextures:
	match icons:
		...
		InputPrompt.Icons.GENERIC:
			return _generic_button_textures
		InputPrompt.Icons.STEAM_DECK:
			return _steam_deck_button_textures
...
func get_joypad_motion_textures(icons: int) -> JoypadMotionTextures:
	match icons:
		...
		InputPrompt.Icons.GENERIC: 
			return _generic_motion_textures
		InputPrompt. Icons.STEAM_DECK: 
			return _steam_deck_motion_textures
		InputPrompt.Icons.KEYBOARD: 
...
func _input(event:  InputEvent):
	...
	if event is InputEventJoypadButton or event is InputEventJoypadMotion:
		...
		# Check for any Valve/SteamOS device (Steam Deck, Steam Machine, etc.)
			...
			joy_icons = InputPrompt.Icons.GENERIC
